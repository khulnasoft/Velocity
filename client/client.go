...
// Client is used to create a Velocity client with client-level settings that
// apply to all requests made by the client.
//
// The Velocity client also provides an option to override or merge most of the
...
func New() *Client {
	...
	// Try to use a pool to reduce the memory allocation cost for the Velocity client and the fasthttp client.
