...
func Test_EnvVarHandler(t *testing.T) {
	...
	req, err := http.NewRequestWithContext(context.Background(), velocity.MethodGet, "http://localhost/envvars", nil)
	require.NoError(t, err)
...
func Test_EnvVarHandlerNotMatched(t *testing.T) {
	...
	app.Get("/another-path", func(ctx velocity.Ctx) error {
		require.NoError(t, ctx.SendString("OK"))
		return nil
	})

	req, err := http.NewRequestWithContext(context.Background(), velocity.MethodGet, "http://localhost/another-path", nil)
	require.NoError(t, err)
	resp, err := app.Test(req)
	require.NoError(t, err)
...
func Test_EnvVarHandlerMethod(t *testing.T) {
	...
	req, err := http.NewRequestWithContext(context.Background(), velocity.MethodPost, "http://localhost/envvars", nil)
	require.NoError(t, err)
	resp, err := app.Test(req)
	require.NoError(t, err)
	require.Equal(t, velocity.StatusMethodNotAllowed, resp.StatusCode)
}
...
func Test_EnvVarHandlerSpecialValue(t *testing.T) {
	...
	req, err = http.NewRequestWithContext(context.Background(), velocity.MethodGet, "http://localhost/envvars/export", nil)
	require.NoError(t, err)
	resp, err = app.Test(req)
	require.NoError(t, err)
