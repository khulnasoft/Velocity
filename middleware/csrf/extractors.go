...
func FromParam(param string) func(c velocity.Ctx) (string, error) {
	return func(c velocity.Ctx) (string, error) {
...
func FromForm(param string) func(c velocity.Ctx) (string, error) {
	return func(c velocity.Ctx) (string, error) {
...
func FromCookie(param string) func(c velocity.Ctx) (string, error) {
	return func(c velocity.Ctx) (string, error) {
...
func FromHeader(param string) func(c velocity.Ctx) (string, error) {
	return func(c velocity.Ctx) (string, error) {
		token := c.Get(param)
		if token == "" {
...
func FromQuery(param string) func(c velocity.Ctx) (string, error) {
	return func(c velocity.Ctx) (string, error) {
		token := velocity.Query[string](c, param)
		if token == "" {
