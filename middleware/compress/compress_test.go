...
func Test_Compress_Gzip(t *testing.T) {
	...
	require.Equal(t, "gzip", resp.Header.Get(velocity.HeaderContentEncoding))
...
func Test_Compress_Deflate(t *testing.T) {
	...
	require.NoError(t, err, "app.Test(req)")
	require.Equal(t, 200, resp.StatusCode, "Status code")
	require.Equal(t, "deflate", resp.Header.Get(velocity.HeaderContentEncoding))
...
func Test_Compress_Brotli(t *testing.T) {
	...
	require.NoError(t, err, "app.Test(req)")
	require.Equal(t, 200, resp.StatusCode, "Status code")
	require.Equal(t, "br", resp.Header.Get(velocity.HeaderContentEncoding))
...
func Test_Compress_Zstd(t *testing.T) {
	...
	require.NoError(t, err, "app.Test(req)")
	require.Equal(t, 200, resp.StatusCode, "Status code")
	require.Equal(t, "zstd", resp.Header.Get(velocity.HeaderContentEncoding))
