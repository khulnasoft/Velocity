...
type Config struct {
	...
	// You can use custom loggers with Velocity by using this field.
	// This field is really useful if you're using Zerolog, Zap, Logrus, apex/log etc.
	// If you don't define anything for this field, it'll use default logger of Velocity.
	//
	// Optional. Default: defaultLogger
	LoggerFunc func(c velocity.Ctx, data *Data, cfg Config) error
...
type LogFunc func(output Buffer, c velocity.Ctx, data *Data, extraParam string) (int, error)
...
// default logging format for Velocity's default logger
