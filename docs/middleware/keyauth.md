...
For a more detailed example, see also the [`go.khulnasoft.com/velocity/recipes`](https://go.khulnasoft.com/velocity/recipes) repository and specifically the `velocity-envoy-extauthz` repository and the [`keyauth example`](https://go.khulnasoft.com/velocity/recipes/blob/master/velocity-envoy-extauthz/authz/main.go) code.
