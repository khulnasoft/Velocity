...
import (
    ...
    "go.khulnasoft.com/velocity/v3/middleware/cache"
)
```
...
app.Use(cache.New(cache.Config{
    Next: func(c velocity.Ctx) bool {
        return velocity.Query[bool](c, "noCache")
    },
...
```go
app.Use(cache.New(cache.Config{
    ExpirationGenerator: func(c velocity.Ctx, cfg *cache.Config) time.Duration {
...
app.Use(cache.New(cache.Config{
    CacheInvalidator: func(c velocity.Ctx) bool {
        return velocity.Query[bool](c, "invalidateCache")
    },
}))
```
...
| CacheInvalidator     | `func(velocity.Ctx) bool`                         | CacheInvalidator defines a function that is executed before checking the cache entry. It can be used to invalidate the existing cache manually by returning true.                                                                                                                                              | `nil`                                                            |
| KeyGenerator         | `func(velocity.Ctx) string`                       | Key allows you to generate custom keys.                                                                                                                                                                                                                                                                        | `func(c velocity.Ctx) string { return utils.CopyString(c.Path()) }` |
| ExpirationGenerator  | `func(velocity.Ctx, *cache.Config) time.Duration` | ExpirationGenerator allows you to generate custom expiration keys based on the request.                                                                                                                                                                                                                        | `nil`                                                            |
| Storage              | `velocity.Storage`                                | Store is used to store the state of the middleware.                                                                                                                                                                                                                                                            | In-memory store                                                  |
| Store (Deprecated)   | `velocity.Storage`                                | Deprecated: Use Storage instead.                                                                                                                                                                                                                                                                               | In-memory store                                                  |
| Key (Deprecated)     | `func(velocity.Ctx) string`                       | Deprecated: Use KeyGenerator instead.                                                                                                                                                                                                                                                                          | `nil`                                                            |
...
| Methods              | `[]string`                                     | Methods specifies the HTTP methods to cache.                                                                                                                                                                                                                                                                   | `[]string{velocity.MethodGet, velocity.MethodHead}`                    |
