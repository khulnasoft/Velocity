...
| <Reference id="colorscheme">ColorScheme</Reference>                                   | [`Colors`](https://go.khulnasoft.com/velocity/blob/master/color.go) | You can define custom color scheme. They'll be used for startup message, route list and some middlewares.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | [`DefaultColors`](https://go.khulnasoft.com/velocity/blob/master/color.go) |
...
| <Reference id="immutable">Immutable</Reference>                                       | `bool`                                                            | When enabled, all values returned by context methods are immutable. By default, they are valid until you return from the handler; see issue [\#185](https://go.khulnasoft.com/velocity/issues/185).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `false`                                                                  |
