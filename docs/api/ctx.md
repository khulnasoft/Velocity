...
```go title="Signature"
func (c velocity.Ctx) Accepts(offers ...string) string
func (c velocity.Ctx) AcceptsCharsets(offers ...string) string
func (c velocity.Ctx) AcceptsEncodings(offers ...string) string
func (c velocity.Ctx) AcceptsLanguages(offers ...string) string
```
...
Velocity provides similar functions for the other accept headers.
...
```go title="Signature"
func (c velocity.Ctx) App() *App
```

```go title="Example"
app.Get("/stack", func(c velocity.Ctx) error {
...
```go title="Signature"
func (c velocity.Ctx) Append(field string, values ...string)
```
...
```go title="Signature"
func (c velocity.Ctx) Attachment(filename ...string)
```
...
```go title="Signature"
func (c velocity.Ctx) AutoFormat(body any) error
```
...
```go title="Signature"
func (c velocity.Ctx) BaseURL() string
```
...
```go title="Signature"
func (c velocity.Ctx) BodyRaw() []byte
```
...
```go title="Signature"
func (c velocity.Ctx) ClearCookie(key ...string)
```
...
```go title="Example"
app.Get("/set", func(c velocity.Ctx) error {
...
app.Get("/delete", func(c velocity.Ctx) error {
    c.Cookie(&velocity.Cookie{
        Name:     "token",
...
```go title="Signature"
func (c velocity.Ctx) ClientHelloInfo() *tls.ClientHelloInfo
```
...
```go title="Signature"
func (c velocity.Ctx) Context() context.Context
```
...
```go title="Signature"
func (c velocity.Ctx) Cookie(cookie *Cookie)
```
...
```go title="Signature"
func (c velocity.Ctx) Cookies(key string, defaultValue ...string) string
```
...
```go title="Signature"
func (c velocity.Ctx) Download(file string, filename ...string) error
```
...
```go title="Signature"
func (c velocity.Ctx) Drop() error
```
...
```go title="Signature"
func (c velocity.Ctx) Format(handlers ...ResFmt) error
```
...
app.Get("/no-default", func(c velocity.Ctx) error {
  return c.Format(
    velocity.ResFmt{"application/json", func(c velocity.Ctx) error {
      return c.JSON(velocity.Map{
        "command": "eat",
        "subject": "fruit",
      })
    }},
    velocity.ResFmt{"text/plain", func(c velocity.Ctx) error {
...
app.Get("/default", func(c velocity.Ctx) error {
  textHandler := func(c velocity.Ctx) error {
    return c.SendString("Eat Fruit!")
  }

  handlers := []velocity.ResFmt{
    {"application/json", func(c velocity.Ctx) error {
      return c.JSON(velocity.Map{
        "command": "eat",
        "subject": "fruit",
      })
...
```go title="Signature"
func (c velocity.Ctx) FormFile(key string) (*multipart.FileHeader, error)
```
...
```go title="Signature"
func (c velocity.Ctx) FormValue(key string, defaultValue ...string) string
```
...
```go title="Signature"
func (c velocity.Ctx) Fresh() bool
```
...
```go title="Signature"
func (c velocity.Ctx) Get(key string, defaultValue ...string) string
```
...
```go title="Signature"
func (c velocity.Ctx) GetReqHeaders() map[string][]string
```
...
```go title="Signature"
func (c velocity.Ctx) GetRespHeader(key string, defaultValue ...string) string
```
...
```go title="Signature"
func (c velocity.Ctx) GetRespHeaders() map[string][]string
```
...
```go title="Signature"
func (c velocity.Ctx) GetRouteURL(routeName string, params Map) (string, error)
```
...
app.Get("/test", func(c velocity.Ctx) error {
    location, _ := c.GetRouteURL("user.show", velocity.Map{"id": 1})
...
```go title="Signature"
func (c velocity.Ctx) Host() string
```
...
```go title="Signature"
func (c velocity.Ctx) Hostname() string
```
...
When registering the proxy request header in the Velocity app, the IP address of the header is returned [(Velocity configuration)](velocity.md#proxyheader)

```go
app := velocity.New(velocity.Config{
  ProxyHeader: velocity.HeaderXForwardedFor,
})
```
...
```go title="Signature"
func (c velocity.Ctx) IPs() []string
```
...
```go title="Signature"
func (c velocity.Ctx) Is(extension string) bool
```
...
```go title="Signature"
func (c velocity.Ctx) IsFromLocal() bool
```
...
If [`TrustProxy`](velocity.md#trustproxy) is `false`, it returns `true`.
`IsProxyTrusted` can check the remote IP by proxy ranges and IP map.

```go title="Signature"
func (c velocity.Ctx) IsProxyTrusted() bool
```
...
```go title="Signature"
func (c velocity.Ctx) JSON(data any, ctype ...string) error
```
...
app.Get("/json", func(c velocity.Ctx) error {
  // Create data struct:
  data := SomeStruct{
    Name: "Grame",
    Age:  20,
...
```go title="Signature"
func (c velocity.Ctx) JSONP(data any, callback ...string) error
```
...
```go title="Signature"
func (c velocity.Ctx) CBOR(data any, ctype ...string) error
```
...
app.Get("/cbor", func(c velocity.Ctx) error {
  // Create data struct:
  data := SomeStruct{
    Name: "Grame",
    Age:  20,
...
```go title="Signature"
func (c velocity.Ctx) Links(link ...string)
```
...
```go title="Signature"
func (c velocity.Ctx) Locals(key any, value ...any) any
```
...
app.Get("/admin", func(c velocity.Ctx) error {
  user, ok := c.Locals(userKey).(string) // Retrieves the data stored under the key and performs a type assertion
  if ok && user == "admin" {
    return c.Status(velocity.StatusOK).SendString("Welcome, admin!")
  }
  return c.SendStatus(velocity.StatusForbidden)
})
```
...
```go title="Signature"
func Locals[V any](c velocity.Ctx, key any, value ...V) V
```

```go title="Example"
app.Use(func(c velocity.Ctx) error {
  velocity.Locals[string](c, "john", "doe")
  velocity.Locals[int](c, "age", 18)
  velocity.Locals[bool](c, "isHuman", true)
  return c.Next()
})
...
```go title="Signature"
func (c velocity.Ctx) Location(path string)
```
...
```go title="Signature"
func (c velocity.Ctx) Method(override ...string) string
```

```go title="Example"
app.Post("/override", func(c velocity.Ctx) error {
  c.Method()          // "POST"
...
```go title="Signature"
func (c velocity.Ctx) MultipartForm() (*multipart.Form, error)
```
...
```go title="Signature"
func (c velocity.Ctx) OriginalURL() string
```
...
```go title="Signature"
func (c velocity.Ctx) Params(key string, defaultValue ...string) string
```
...
```go title="Example"
app.Get("/v1/*/shop/*", func(c velocity.Ctx) error {
...
just strings. This can be achieved using a generic `Params` function known as `Params[V GenericType](c velocity.Ctx, key string, defaultValue ...V) V`.
...
```go title="Signature"
func Params[V GenericType](c velocity.Ctx, key string, defaultValue ...V) V
```

```go title="Example"
// GET http://example.com/user/114
app.Get("/user/:id", func(c velocity.Ctx) error{
  velocity.Params[string](c, "id") // returns "114" as string.
  velocity.Params[int](c, "id")    // returns 114 as integer
  velocity.Params[string](c, "number") // returns "" (default string type)
  velocity.Params[int](c, "number")    // returns 0 (default integer value type)
})
```
...
```go title="Signature"
func (c velocity.Ctx) Path(override ...string) string
```

```go title="Example"
// GET http://example.com/users?sort=desc

app.Get("/users", func(c velocity.Ctx) error {
  c.Path()       // "/users"
...
```go title="Signature"
func (c velocity.Ctx) Port() string
```
...
```go title="Signature"
func (c velocity.Ctx) Protocol() string
```
...
```go title="Signature"
func (c velocity.Ctx) Queries() map[string]string
```
...
```go title="Signature"
func (c velocity.Ctx) Query(key string, defaultValue ...string) string
```
...
just strings. This can be achieved using a generic `Query` function known as `Query[V GenericType](c velocity.Ctx, key string, defaultValue ...V) V`.
...
```go title="Signature"
func Query[V GenericType](c velocity.Ctx, key string, defaultValue ...V) V
```
...
app.Get("/", func(c velocity.Ctx) error {
  velocity.Query[int](c, "page")     // 1
  velocity.Query[string](c, "brand") // "nike"
  velocity.Query[bool](c, "new")     // true
...
```go title="Signature"
func (c velocity.Ctx) Range(size int) (Range, error)
```
...
```go title="Signature"
func (c velocity.Ctx) Redirect() *Redirect
```
...
```go title="Signature"
func (c velocity.Ctx) Request() *fasthttp.Request
```
...
```go title="Signature"
func (c velocity.Ctx) RequestCtx() *fasthttp.RequestCtx
```
...
```go title="Signature"
func (c velocity.Ctx) Response() *fasthttp.Response
```
...
```go title="Signature"
func (c velocity.Ctx) Reset(fctx *fasthttp.RequestCtx)
```

It is used outside of the Velocity Handlers to reset the context for the next request.
...
```go title="Signature"
func (c velocity.Ctx) RestartRouting() error
```
...
app.Get("/hello/:name", func(c velocity.Ctx) error {
  r := c.Route()
...
```go title="Example"
func MyMiddleware() velocity.Handler {
...
```go title="Signature"
func (c velocity.Ctx) SaveFile(fh *multipart.FileHeader, path string) error
```
...
```go title="Signature"
func (c velocity.Ctx) SaveFileToStorage(fileheader *multipart.FileHeader, path string, storage Storage) error
```
...
:::info
Please use [`Config.TrustProxy`](velocity.md#trustproxy) to prevent header spoofing if your app is behind a proxy.
:::

```go title="Signature"
func (c velocity.Ctx) Schema() string
```
...
```go title="Signature"
func (c velocity.Ctx) Secure() bool
```
...
```go title="Signature"
func (c velocity.Ctx) Send(body []byte) error
```
...
Velocity also provides `SendString` and `SendStream` methods for raw inputs.
...
```go title="Signature"
func (c velocity.Ctx) SendString(body string) error
func (c velocity.Ctx) SendStream(stream io.Reader, size ...int) error
```
...
type SendFile struct {
  ...
  // This works differently than the github.com/khulnasoft/compression middleware.
...
func (c velocity.Ctx) SendFile(file string, config ...SendFile) error
```

```go title="Example"
app.Get("/not-found", func(c velocity.Ctx) error {
  return c.SendFile("./public/404.html")

  // Disable compression
  return c.SendFile("./static/index.html", velocity.SendFile{
    Compress: false,
  })
})
```
...
```go title="Example"
app.Get("/file-with-url-chars", func(c velocity.Ctx) error {
...
```go title="Example"
app.Get("/file", func(c velocity.Ctx) error {
  return c.SendFile("style.css", velocity.SendFile{
    CacheDuration: -1,
  })
})
```
...
:::info
You can use multiple `SendFile` calls with different configurations in a single route. Velocity creates different filesystem handlers per config.
:::
...
```go title="Signature"
func (c velocity.Ctx) SendStatus(status int) error
```
...
```go title="Example"
app.Get("/wait", func(c velocity.Ctx) error {
  return c.SendStreamWriter(func(w *bufio.Writer) {
    // Begin Work
...
```go title="Signature"
func (c velocity.Ctx) Set(key string, val string)
```
...
```go title="Signature"
func (c velocity.Ctx) SetContext(ctx context.Context)
```
...
```go title="Signature"
func (c velocity.Ctx) Stale() bool
```
...
```go title="Signature"
func (c velocity.Ctx) Status(status int) velocity.Ctx
```

```go title="Example"
app.Get("/velocity", func(c velocity.Ctx) error {
  c.Status(velocity.StatusOK)
  return nil
})

app.Get("/hello", func(c velocity.Ctx) error {
  return c.Status(velocity.StatusBadRequest).SendString("Bad Request")
})

app.Get("/world", func(c velocity.Ctx) error {
  return c.Status(velocity.StatusNotFound).SendFile("./public/gopher.png")
})
```
...
```go title="Signature"
func (c velocity.Ctx) String() string
```
...
```go title="Signature"
func (c velocity.Ctx) Subdomains(offset ...int) []string
```
...
```go title="Signature"
func (c velocity.Ctx) Type(ext string, charset ...string) velocity.Ctx
```
...
```go title="Signature"
func (c velocity.Ctx) Vary(fields ...string)
```
...
```go title="Signature"
func (c velocity.Ctx) ViewBind(vars Map) error
```

```go title="Example"
app.Use(func(c velocity.Ctx) error {
  c.ViewBind(velocity.Map{
    "Title": "Hello, World!",
  })
  return c.Next()
})
...
app.Get("/", func(c velocity.Ctx) error {
  return c.Render("xxx.tmpl", velocity.Map{}) // Render will use the Title variable
})
```
...
```go title="Signature"
func (c velocity.Ctx) Write(p []byte) (n int, err error)
```
...
```go title="Signature"
func (c velocity.Ctx) Writef(format string, a ...any) (n int, err error)
```
...
```go title="Signature"
func (c velocity.Ctx) WriteString(s string) (n int, err error)
```
...
```go title="Signature"
func (c velocity.Ctx) XML(data any) error
```
