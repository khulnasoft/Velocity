...
Sessions are stored in memory for this example, but you can use any session store you like. See the [Fiber session documentation](https://docs.khulnasoft.io/api/middleware/session) for more information.
