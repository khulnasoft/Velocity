...
func UpdateBook(service book.Service) velocity.Handler {
	return func(c *velocity.Ctx) error {
		var requestBody entities.Book
		err := c.BodyParser(&requestBody)
		if err != nil {
...
func RemoveBook(service book.Service) velocity.Handler {
	return func(c *velocity.Ctx) error {
...
func GetBooks(service book.Service) velocity.Handler {
	return func(c *velocity.Ctx) error {
