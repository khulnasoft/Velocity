...
func NewUserHandler(userRoute velocity.Router, us UserService) {
...
// Gets all users.
func (h *UserHandler) getUsers(c *velocity.Ctx) error {
...
// Gets a single user.
func (h *UserHandler) getUser(c *velocity.Ctx) error {
	// Create cancellable context.
	customContext, cancel := context.WithCancel(context.Background())
	defer cancel()
...
func (h *UserHandler) createUser(c *velocity.Ctx) error {
...
func (h *UserHandler) updateUser(c *velocity.Ctx) error {
	// Initialize variables.
	user := &User{}
...
func (h *UserHandler) deleteUser(c *velocity.Ctx) error {
