...
func NewAuthHandler(authRoute velocity.Router) {
	handler := &AuthHandler{}
...
func (h *AuthHandler) signInUser(c *velocity.Ctx) error {
...
func (h *AuthHandler) signOutUser(c *velocity.Ctx) error {
	c.Cookie(&velocity.Cookie{
		Name:     "jwt",
		Value:    "loggedOut",
		Path:     "/",
...
func (h *AuthHandler) privateRoute(c *velocity.Ctx) error {
