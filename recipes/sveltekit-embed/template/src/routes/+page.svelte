<script>
	...
	import { khulnasoft_code, robustRouting, serverStaticFiles } from './lib/store/code';
</script>

<svelte:head>
	<title>Velocity & Sveltekit Embed App</title>
</svelte:head>
<section class="flex flex-col">
	<div class="flex flex-col justify-center p-4">
		...
		<blockquote class="blockquote my-2">
			<p>
				Velocity is a Go web framework built on top of Fasthttp, the <strong>fastest</strong> HTTP
		...
		<div class="flex flex-col lg:flex-row">
			...
			<div class="w-full h-96 flex flex-col">
				<div class="flex-grow">
					<CodeBlock lineNumbers={true} rounded="rounded-t-lg" language="go" code={$khulnasoft_code} />
				</div>
			</div>
			<!---Code Block End-->
