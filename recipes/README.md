...
# 🍳 Recipes for [Fiber](https://github.com/khulnasoft/fiber)
...
We are ready to accept your [PR](https://github.com/khulnasoft/recipes/pulls) and add your recipe to the cookbook (both on [website](https://docs.khulnasoft.io) and this repository).
