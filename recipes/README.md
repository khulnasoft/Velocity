...
# 🍳 Recipes for [Velocity](https://github.com/khulnasoft/velocity)

**Welcome to the official Velocity cookbook**!
...
- [gRPC](./grpc/README.md) - Using Velocity as a client to a gRPC server.
...
- [Unit Testing](./unit-test/README.md) - Writing unit tests for a Go Velocity application.
...
If you have found an amazing recipe for **Velocity** — share it with others!
We are ready to accept your [PR](https://go.khulnasoft.com/velocity/recipes/pulls) and add your recipe to the cookbook (both on [website](https://docs.khulnasoft.io) and this repository).
