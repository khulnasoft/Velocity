...
func main() {
	...
	app.Get("/employee", func(c *velocity.Ctx) error {
	...
	app.Get("/employee/:id", func(c *velocity.Ctx) error {
		// get id by params
		params := c.Params("id")
	...
	app.Put("/employee/:id", func(c *velocity.Ctx) error {
		idParam := c.Params("id")
	...
	app.Delete("/employee/:id", func(c *velocity.Ctx) error {
