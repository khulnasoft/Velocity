...
func Test_FunctionName(t *testing.T) {
	t.Parallel()
	require.Equal(t, "go.khulnasoft.com/velocity/lib/utils.Test_UUID", FunctionName(Test_UUID))
	require.Equal(t, "go.khulnasoft.com/velocity/lib/utils.Test_FunctionName.func1", FunctionName(func() {}))
