...
![Release](https://img.shields.io/github/v/tag/khulnasoft/storage?filter=memory*)
...
![Test](https://img.shields.io/github/actions/workflow/status/khulnasoft/storage/test-memory.yml?label=Tests)
...
```go
import "go.khulnasoft.com/velocity/storage/memory/v2"
```
