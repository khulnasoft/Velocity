...
![Release](https://img.shields.io/github/v/tag/khulnasoft/storage?filter=scylladb*)
...
![Test](https://img.shields.io/github/actions/workflow/status/khulnasoft/storage/test-scylladb.yml?label=Tests)
...
A ScyllaDb storage engine for [Velocity](https://github.com/khulnasoft/velocity) using [gocql](https://github.com/scylladb/gocql).
...
```bash
go get go.khulnasoft.com/velocity/storage/scylladb
```

### Examples
Import the storage package.
```go
import "go.khulnasoft.com/velocity/storage/scylladb"
```
