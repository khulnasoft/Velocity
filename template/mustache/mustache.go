...
import (
	...
	core "github.com/khulnasoft/velocity/template"
...
// New returns a Mustache render engine for Velocity
...
// NewFileSystem returns a Mustache render engine for Velocity that supports embedded files
func NewFileSystem(fs http.FileSystem, extension string) *Engine {
	return NewFileSystemPartials(fs, extension, fs)
}

// NewFileSystemPartials returns a Handlebar render engine for Velocity that supports embedded files
