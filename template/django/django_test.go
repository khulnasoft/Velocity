...
func Test_GetPongoBinding(t *testing.T) {
	...
	// Test with velocity.Map
	velocityMap := velocity.Map{"key3": "value3"}
	result = getPongoBinding(velocityMap)
	assert.Equal(t, pongo2.Context(velocityMap), result, "Expected the same context")
