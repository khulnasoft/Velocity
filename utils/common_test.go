...
func Test_FunctionName(t *testing.T) {
	t.Parallel()
	require.Equal(t, "github.com/khulnasoft/velocity/utils.Test_UUID", FunctionName(Test_UUID))
	require.Equal(t, "github.com/khulnasoft/velocity/utils.Test_FunctionName.func1", FunctionName(func() {}))
