...
func Test_Bind_Header(t *testing.T) {
	...
	c.Request().Header.Add("Hobby", "golang,velocity")
	q := new(Header)
	require.NoError(t, c.Bind().Header(q))
	require.Len(t, q.Hobby, 1)

	c.Request().Header.Del("hobby")
	c.Request().Header.Add("Hobby", "golang,velocity,go")
	q = new(Header)
	require.NoError(t, c.Bind().Header(q))
	require.Len(t, q.Hobby, 1)
	...
	c.Request().Header.Del("hobby")
	c.Request().Header.Add("Hobby", "go,velocity")
	...
	require.Equal(t, "go,velocity", h2.Hobby)
...
func Test_Bind_RespHeader(t *testing.T) {
	...
	c.Response().Header.Add("Hobby", "golang,velocity")
	q := new(Header)
	require.NoError(t, c.Bind().RespHeader(q))
	require.Len(t, q.Hobby, 2)

	c.Response().Header.Del("hobby")
	c.Response().Header.Add("Hobby", "golang,velocity,go")
	q = new(Header)
	require.NoError(t, c.Bind().RespHeader(q))
	require.Len(t, q.Hobby, 3)
	...
	c.Response().Header.Del("hobby")
	c.Response().Header.Add("Hobby", "go,velocity")
...
func Test_Bind_Cookie(t *testing.T) {
	...
	c.Request().Header.SetCookie("Hobby", "golang,velocity")
	q := new(Cookie)
	require.NoError(t, c.Bind().Cookie(q))
	require.Len(t, q.Hobby, 2)

	c.Request().Header.DelCookie("hobby")
	c.Request().Header.SetCookie("Hobby", "golang,velocity,go")
	q = new(Cookie)
	require.NoError(t, c.Bind().Cookie(q))
	require.Len(t, q.Hobby, 3)
	...
	c.Request().Header.DelCookie("hobby")
	c.Request().Header.SetCookie("Hobby", "go,velocity")
